...
//                                         show.time,
//                                         show.screen,
//                                         '/thodarum/buytickets/cosmoscinemaseatlayout'
//                                     )
//                                 }
...
//                   show.time,
//                   show.screen,
//                   "/thodarum/buytickets/karpagamcinemaseatlayout"
//                 )
//               }
//               className="time-holding-div"
//             >
...
//                   show.time,
//                   show.screen,
//                   "/thodarum/buytickets/murugancinemaseatlayout"
//                 )
//               }
//               className="time-holding-div"
//             >
...
//                   show.time,
//                   show.screen,
//                   "/thodarum/buytickets/kalpanacinemaseatlayout"
//                 )
//               }
//               className="time-holding-div"
//             >
...
//     const layoutPath = `/thodarum/buytickets/${formattedTheater}seatlayout`;
...
// export default ThodarumBuytickets;
...
function ThodarumBuytickets() {
  ...
  // ✅ Fetch theaters for "Thodarum" movie
  useEffect(() => {
    const fetchTheaters = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/movies");
        const thodarumMovie = response.data.find(
          (m) => m.name.toLowerCase() === "thodarum"
        );

        if (!thodarumMovie) {
          console.warn("Thodarum movie not found in response");
          return;
        }

        // ✅ Map enabled theaters with screen + showtime structure
        const enabledTheaters = thodarumMovie.theaters
