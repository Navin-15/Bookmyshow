...
//                 time: showTime,
//                 screen: screen,
//                 movieName: "HIT: The Third Case",  // Assuming "HIT: The Third Case" is static for this page
...
//                             <div className="name">HIT: The Third Case - (Tamil)</div>
//                         </div>
//                         <div className="abtthismovie">
//                             <a href="" className=" outline">Crime</a>
//                             <a href="" className=" outline">Mystery</a>
...
//                                         show.time,
//                                         show.screen,
//                                         '/hit/buytickets/cosmoscinemaseatlayout'
//                                     )
//                                 }
...
//                   show.time,
//                   show.screen,
//                   "/hit/buytickets/karpagamcinemaseatlayout"
//                 )
//               }
//               className="time-holding-div"
//             >
...
//                   show.time,
//                   show.screen,
//                   "/hit/buytickets/murugancinemaseatlayout"
//                 )
//               }
//               className="time-holding-div"
//             >
...
//                   show.time,
//                   show.screen,
//                   "/hit/buytickets/kalpanacinemaseatlayout"
//                 )
//               }
//               className="time-holding-div"
//             >
...
//     const layoutPath = `/Hit/buytickets/${formattedTheater}seatlayout`;
...
//             <div className="name">HIT: The Third Case</div>
//           </div>
...
function HitBuytickets() {
  ...
  // ✅ Fetch theaters for "HIT" movie
  useEffect(() => {
    const fetchTheaters = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/movies");
        const hitMovie = response.data.find(
          // (m) => m.name.toLowerCase() === "hit"
          (m) => m.name.toLowerCase().includes("hit")
        );

        if (!hitMovie) {
          console.warn("HIT movie not found in response");
          console.log("Available movie names:", response.data.map(m => m.name));
          return;
        }

        // ✅ Map enabled theaters with proper nested screen + showtime structure
        const enabledTheaters = hitMovie.theaters
