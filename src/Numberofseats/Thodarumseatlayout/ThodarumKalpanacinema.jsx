...
// updated final code blocking and un-blocking seats are not-working 
...
//   const [selectedDate, setSelectedDate] = useState(new Date());
//   const [bookedSeats, setBookedSeats] = useState([]);
//   const [blockedSeats, setBlockedSeats] = useState([]); // ✅ new state for blocked seats
//   const [selectedTime, setSelectedTime] = useState("");
...
//         // Fetch booked seats
//         const bookedResponse = await axios.get('http://localhost:5000/api/bookings', { params });
//         const allBooked = bookedResponse.data.flatMap(b => b.seats);

//         // Fetch blocked seats
//         const blockedResponse = await axios.get('http://localhost:5000/api/admin/blocked-seats', { params });
//         const allBlocked = blockedResponse.data;

//         // Merge both booked + blocked
//         const merged = Array.from(new Set([...allBooked, ...allBlocked]));

//         setBookedSeats(allBooked);
//         setBlockedSeats(allBlocked);
//       } catch (err) {
...
//     // Prevent selecting blocked/booked seat
...
//     if (isBooked) return 'seatno orange-disabled'; // booked
//     if (isBlocked) return 'seatno orange-disabled'; // blocked seats also orange
//     if (isSelected) return 'seatno selected-seat px-2 text-center';
//     return 'seatno availabledouble px-1 text-center';
//   };
...
//               <span style={{ fontSize: "13px", fontWeight: "700", color: "white", backgroundColor: "rgba(58, 130, 93, 1)", padding: "8px 10px", borderRadius: "2px" }}>{selectedTime}</span>&nbsp;&nbsp;
//               <span style={{ fontSize: "13px", fontWeight: "700", color: "white", backgroundColor: "rgba(58, 130, 93, 1)", padding: "8px 10px", borderRadius: "2px" }}>{screen}</span>
//             </div>
//           </div>
//         </div>
//       </div>
...
//                                   handleSeatClick(row, seatNo, category);
//                                 }}
//                                 style={(bookedSeats.includes(`${row}${seatNo}`) || blockedSeats.includes(`${row}${seatNo}`))
//                                   ? { cursor: 'not-allowed' } : {}}
//                               >
//                                 {seatNo}
//                               </a>
...
//         <div className="w-50 d-flex mt-2 justify-content-center">
//           <div className="w-25 ">
//             <div className="seatempty"><span className='seatno availabledouble' style={{ padding: "10px", width: "20px", height: "20px", position: "relative", bottom: '4px' }}></span></div>
//             Available
//           </div>
//           <div className="w-25">
//             <div className="seatempty"><span className='seatno selected-seat' style={{ padding: "10px", width: "20px", height: "20px", position: "relative", bottom: '4px' }}></span></div>
//             Selected
//           </div>
//           <div className="w-25">
//             <div className="seatempty"><span className='seatno orange-disabled' style={{ padding: "10px", width: "20px", height: "20px", position: "relative", bottom: '4px' }}></span></div>
//             Booked / Blocked
//           </div>
//         </div>
//       </div>
