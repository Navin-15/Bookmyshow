...
//   // Multiple valid usernames and passwords
//   const validUsers = {
//     'admin@gmail.com': 'admin12345@*#',
//     'developer@gmail.com': 'password1',
//     'user2@gmail.com': 'password2',
//     'johnDoe@gmail.com': 'jd2025!',
//     'janeSmith@gmail.com': 'jsSecurePass',
//   };

//   // Check if username exists and password matches
//   if (validUsers[usernameInput] && validUsers[usernameInput] === password) {
//     setUsername(usernameInput);
//     navigate('/dashboard');
//   } else {
//     setError('Invalid username or password. Please try again.');
...
//     try {
//       const res = await axios.post('http://localhost:5000/api/logins/login', {
//         email,
//         password,
//       });
...
//       setUsername(res.data.name || res.data.email); // Optional: update context
//       navigate('/dashboard');
//     } catch (err) {
