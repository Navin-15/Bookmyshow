...
//   password: "",  // Password should be re-entered or updated
//   confirmPassword: "",
...
//     if (!validatePermissions(form.permissions)) newErrors.permissions = "Please select at least one permission";
...
//         <h3 className="newform">New User Form</h3>
...
const Newuser = () => {
  ...
  const defaultPermissions = {
    ...
    booking: false,
    customer: false,
    theaterseats: false, // ✅ NEW PERMISSION ADDED
  };
